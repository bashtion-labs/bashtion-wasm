...
globalThis.Module = {
    arguments: [
        ...
        '-append', 'console=ttyS0,115200n8 root=/dev/vda rw rootwait nokaslr nosoftlockup nowatchdog random.trust_cpu=on modules_load=virtio_rng quiet systemd.show_status=0',
